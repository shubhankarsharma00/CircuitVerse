...
export function showProperties(obj) {
    ...
    if (simulationArea.lastSelected === undefined || ['Wire', 'CircuitElement', 'Node'].indexOf(simulationArea.lastSelected.objectType) !== -1) {
        ...
        $('#moduleProperty-inner').append(`<p><span>Project Title:</span> <input class='objectPropertyAttribute' type='text'  name='setProjectName'  value='${projectName || 'Untitled'}'></p>`);
        ...
        $('#moduleProperty-inner').append(`<p><span>Clock Time:</span> <input class='objectPropertyAttribute' min='50' type='number' style='width:100px' step='10' name='changeClockTime'  value='${simulationArea.timePeriod}'>ms</p>`);
